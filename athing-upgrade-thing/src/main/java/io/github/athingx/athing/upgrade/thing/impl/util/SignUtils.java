...
public class SignUtils {
    private static final int[] CRC16_IBM_TABLE = new int[]{ 0x0000, 0xC0C1, 0xC181, 0x0140, 0xC301, 0x03C0, 0x0280, 0xC241, 0xC601, 0x06C0, 0x0780, 0xC741,
    ...
    public static int crc16_ibm(byte[] data, int offset, int length) {
        ...
        final var ret = new byte[]{(byte) (0xff & crc), (byte) ((0xff00 & crc) >> 8)};
